...
## 0.0.2
Bundle Android and iOS libraries through the build hook so standalone Dart
projects can install the same package. Declare the supported native platforms.
